...
function SideCard({ item, index }: SideCardProps) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -4 }}
      className="rounded-2xl border border-slate-700/60 bg-gradient-to-b from-slate-800/60 to-slate-900/60 p-5 shadow-lg backdrop-blur-sm transition-colors duration-300 hover:border-cyan-400/40"
    >
      ...
      <div className="mt-4 flex gap-2">
        <button className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-700 text-slate-300 transition hover:bg-cyan-500 hover:text-white hover:border-cyan-500">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="grid items-center gap-6 lg:grid-cols-[1fr_1.4fr_1fr]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-3xl border border-slate-700/60 bg-gradient-to-br from-slate-800/70 via-slate-900/70 to-slate-950/70 p-6 shadow-2xl backdrop-blur-sm sm:p-8"
          >
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-center">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="mt-6 flex justify-center gap-3 sm:justify-start">
                  <button className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700 text-slate-300 transition hover:bg-cyan-500 hover:text-white hover:border-cyan-500">
